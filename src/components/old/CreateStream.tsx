...
import down from "../assets/icons8_scroll_down.svg"; // Adjust the path to the correct location of the 'down' image
...
function StreamCreation() {
  ...
  function handleSubmit(event: React.FormEvent) {
    event.preventDefault();
    // TODO: handle stream creation logic
    ...
    <form className="flex flex-col gap-5" onSubmit={handleSubmit}>
      <div className="relative">
        <select
          name="department"
          id="department"
          className="border border-gray-400 rounded-sm font-normal text-sm p-3 w-full appearance-none bg-transparent focus:border-green-700 focus:outline-none"
        >
      ...
      <input
        ...
        className="border border-gray-400 rounded-sm text-sm p-2 focus:border-green-700 focus:outline-none"
      />
      <textarea
